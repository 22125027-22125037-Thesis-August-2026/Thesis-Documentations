...
Table~\ref{tab:events} catalogs the domain events exchanged over the broker.
...
\paragraph{Emergency path.} The emergency-support area is a dedicated screen
