...
|---|---|---|---|---|
| [Auth](Auth-Service.md) | 8081 | uMatter-Backend (monorepo) | `auth_db` | Identity, JWT/JWKS, profiles, grants, license verification |
| [AI](AI-Service.md) | 8087 | uMatter-Backend (monorepo) | `ai_db` | Gemini-powered companion grounded in user context |
| [Tracking](Tracking-Service.md) | 8084 | uMatter-Backend (monorepo) | `tracking_db` | Mood/sleep/food/diary/steps/breathing/streaks/treasures |
| [Dashboard](Dashboard-Service.md) | 8083 | uMatter-Backend (monorepo) | none (BFF) | Aggregates other services for the clients |
| [Therapist API](Therapist-API.md) | 8085 | therapist-api | booking DB | Matching, availability, booking, Zoom, notes, reviews |
| [Social](Social-API.md) | 8086 | thesis_social | social DB | Friends + real-time STOMP chat |
| [Notification](Notification-API.md) | 8082 | notification-api | `notification` | Event-driven push + email + inbox |
